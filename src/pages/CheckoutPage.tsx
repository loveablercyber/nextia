    ...
    try {
      ...
      const bodyPayload = selection!.kind === 'plan'
        ...
        : selection!.kind === 'draft'
          ? { draftId: selection!.id, notes }
          : { serviceSlug: selection!.id, notes };
