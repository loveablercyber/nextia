...
export default function TemplateDemoPage() {
  ...
  return (
    ...
    >
      {/* Return button & Plan selector overlay */}
      <div
        className="py-3 px-4 flex flex-wrap items-center justify-between gap-3 sticky top-0 z-50 backdrop-blur-md border-b"
      ...
      >
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-[#1F2937] text-white text-xs font-bold px-3 py-1.5 rounded-lg border border-gray-700 focus:outline-none focus:border-[#5B4FE9] cursor-pointer"
            >
        ...
        {/* Toggle Button & Language selector */}
      ...
      {showPlanCard && (
        <div className="bg-[#1F2937] border-b border-gray-700/50 p-4 sm:p-6 shadow-2xl relative z-40 animate-fade-in-up text-white">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs border-y md:border-y-0 md:border-x border-gray-700/50 py-4 md:py-0 md:px-6 w-full">
