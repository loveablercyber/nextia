...
VALUES
  ('tpl-restaurante-premium', 'restaurante-premium', 'sites-prontos', 'Restaurante Premium', 'Restaurante', 'Site pronto para restaurantes com cardápio digital, reservas e galeria.', '', '/demo/restaurante-premium', '["Cardápio digital","Reservas online","WhatsApp integrado"]'::jsonb, TRUE, TRUE, 7900, 19700, 10),
  ('tpl-salao-elegance', 'salao-elegance', 'sites-prontos', 'Salão Elegance', 'Salão & Barbearia', 'Site pronto para salões e barbearias com agenda e portfólio.', '', '/demo/salao-elegance', '["Agendamento online","Portfólio","WhatsApp integrado"]'::jsonb, TRUE, TRUE, 6900, 19700, 20),
  ('tpl-servicos-profissionais', 'servicos-profissionais', 'sites-prontos', 'Serviços Profissionais', 'Prestador de Serviços', 'Site pronto para profissionais e empresas de serviços.', '', '/demo/servicos-profissionais', '["Serviços","Portfólio","Solicitação de orçamento"]'::jsonb, TRUE, TRUE, 5900, 19700, 30),
  ('tpl-loja-catalogo', 'loja-catalogo', 'sites-prontos', 'Loja & Catálogo', 'Loja e Catálogo', 'Catálogo digital com filtros e vendas pelo WhatsApp.', '', '/demo/loja-catalogo', '["Catálogo de produtos","Filtros","WhatsApp integrado"]'::jsonb, FALSE, TRUE, 8900, 24700, 40),
  ('tpl-clinica-estetica', 'clinica-estetica', 'sites-prontos', 'Clínica & Estética', 'Clínica e Estética', 'Site pronto para clínicas, consultórios e centros de estética.', '', '/demo/clinica-estetica', '["Tratamentos","Equipe","Agendamento"]'::jsonb, FALSE, TRUE, 8900, 24700, 50),
  ('tpl-contabilidade', 'contabilidade', 'sites-prontos', 'Escritório Contábil', 'Contabilidade', 'Site pronto para contadores e escritórios contábeis.', '', '/demo/contabilidade', '["Serviços contábeis","Blog","Orçamento"]'::jsonb, FALSE, TRUE, 6900, 19700, 60),
  ('tpl-imobiliaria', 'imobiliaria', 'sites-prontos', 'Imobiliária', 'Imobiliária', 'Site pronto para imobiliárias com listagem e busca de imóveis.', '', '/demo/imobiliaria', '["Listagem de imóveis","Filtros","Captação de leads"]'::jsonb, FALSE, TRUE, 12900, 29700, 70),
  ('tpl-oficina-mecanica', 'oficina-mecanica', 'sites-prontos', 'Oficina Mecânica', 'Oficina Mecânica', 'Site pronto para oficinas e centros automotivos.', '', '/demo/oficina-mecanica', '["Serviços","Orçamento","WhatsApp integrado"]'::jsonb, FALSE, TRUE, 5900, 19700, 80),
  ('tpl-imobiliaria-premium', 'imobiliaria-premium', 'sites-prontos', 'Imobiliária Premium', 'Imobiliária', 'Plataforma pronta para imobiliárias de alto padrão.', '', '/demo/imobiliaria-premium', '["Busca avançada","Tour 360°","Simulador"]'::jsonb, TRUE, TRUE, 14900, 39700, 90),
  ('tpl-loja-moda-premium', 'loja-moda-premium', 'lojas-virtuais', 'Loja Moda & Acessórios', 'Loja Virtual', 'Loja virtual de moda com variações, frete e checkout.', '', '/demo/loja-moda-premium', '["Grade de tamanhos","Checkout integrado","Estoque"]'::jsonb, TRUE, TRUE, 9900, 24700, 100),
  ('tpl-loja-gourmet', 'loja-gourmet', 'lojas-virtuais', 'Loja Gourmet & Alimentos', 'Loja Virtual', 'Loja virtual para alimentos com pedidos e Pix.', '', '/demo/loja-gourmet', '["Catálogo","Pedidos por WhatsApp","Pix"]'::jsonb, TRUE, TRUE, 5900, 19700, 110),
  ('tpl-loja-tech-store', 'loja-tech-store', 'lojas-virtuais', 'Loja Tech & Eletrônicos', 'Loja Virtual', 'Loja virtual robusta para eletrônicos e informática.', '', '/demo/loja-tech-store', '["Ficha técnica","Gateways múltiplos","Relatórios"]'::jsonb, TRUE, TRUE, 15900, 29700, 120)
