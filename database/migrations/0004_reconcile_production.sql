-- Migration 0004: Reconcile production database schema safely and idempotently
...
-- 4. Pricing Quotes & Webhook Events
...
-- 6. Service Engagements, Domains & Order Items
...
-- 9. Foreign keys & column extensions on Projects & Files
